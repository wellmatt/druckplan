          ...
          <form action="index.php?page=<?=$_REQUEST['page']?>" method="post" id="group_form" name="group_form"
              ...
              <br>
                 <div class="row">
                     <div class="col-md-6">
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Recht</label>
                             <label for="" class="col-sm-1 control-label">Ja/Nein</label>
                         </div>
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Darf Urlaub genehmigen</label>
                             <div class="col-sm-1">
                                 <input type="checkbox" class="form-control" name="right_urlaub" value="1" <? if($group->hasRight(Group::RIGHT_URLAUB)) echo "checked";?>>
                             </div>
                         </div>
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Maschinenauswahl in Kalkulation anzeigen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Ausführliche Kalkulation anzeigen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Sollzeiten anzeigen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Teilaufträge plane</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Fremde Kalender benutzen / bearbeiten</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Alle Kalender einsehen</label>
                             <div class="col-sm-1">
                     ...
                     <div class="col-md-6">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Ansprechpartner löschen</label>
                             <div class="col-sm-1">
                                 <input type="checkbox" class="form-control"  name="right_delete_cp" value="1" <? if($group->hasRight(Group::RIGHT_DELETE_CP)) echo "checked";?>>
                             </div>
                         </div>
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Kalkulationen löschen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Vorgänge löschen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Planung löschen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Vorgänge zusammenführen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Ticket Ersteller ändern</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Ticket-Kommentar 'Intern' ändern</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Ticket-Kommentar 'Offiziell' ändern</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Verknüpfung löschen</label>
                             <div class="col-sm-1">
                         ...
                         <div class="form-group">
                             <label for="" class="col-sm-3 control-label">Zugriff auf GK-Notizen</label>
                             <div class="col-sm-1">
