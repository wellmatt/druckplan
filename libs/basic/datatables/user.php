...
Editor::inst( $db, 'user' )
    ...
    ->fields(
        ...
        Field::inst( 'user_firstname' )->validator( 'Validate::notEmpty' ),
        Field::inst( 'user_lastname' )->validator( 'Validate::notEmpty' ),
        Field::inst( 'user_email' )->validator( 'Validate::notEmpty' )
    )
    ->process( $_POST )
    ->json();
