...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <?php if($content_part != 1){?>
            <div class="form-group">
                <div class="col-sm-12" style="text-align: center">
                    <button type="button" class="btn btn-info" onclick="togglePart(this, <?php echo $content_part;?>);">Nicht vorhanden</button>
                </div>
            </div>
        <?php }?>
        <div id="part_<?php echo $content_part;?>_content" style="display: block">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input name="part_<?php echo $content_part; ?>_product_width" class="form-control"
                                               id="part_<?php echo $content_part; ?>_product_width" value="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input name="part_<?php echo $content_part; ?>_product_width_open"
                                               class="form-control"
                                               id="part_<?php echo $content_part; ?>_product_width_open" value="">
                                        <span class="input-group-addon">mm</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input name="part_<?php echo $content_part; ?>_product_height" class="form-control"
                                               id="part_<?php echo $content_part; ?>_product_height" value="">
                                        <span class="input-group-addon">mm</span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input name="part_<?php echo $content_part; ?>_product_height_open"
                                               class="form-control"
                                               id="part_<?php echo $content_part; ?>_product_height_open" value="">
                                        <span class="input-group-addon">mm</span>
                                    </div>
                                </div>
                            </div>
