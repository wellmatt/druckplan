...
foreach (Calculation::getAllCalculations($order,Calculation::ORDER_AMOUNT) as $calc) {
    ...
    <div class="panel panel-default">
    	  ...
    	  <div class="panel-body slidepanel panel-collapsed" style="display: none;">
                                  ...
                                  <div class="col-md-3">
                                      <div class="panel panel-default">
                                          ...
                                          <ul class="list-group">
                                              ...
                                              <li class="list-group-item">
                                                  <span class="badge"><?=$calc->getUsagePerPaper($content['const']); ?></span>
<!--                                                  <span class="badge">--><?//= $calc->getProductsPerPaper($content['const']) ?><!--</span>-->
              ...
              <div class="panel panel-success">
                  ...
                  <ul class="list-group">
                      ...
                      <li class="list-group-item">
                          <span class="badge"><?php echo printPrice($calc->getSubMaterial()) ; ?>€</span>
                          Materialkosten
                      </li>
                      <li class="list-group-item">
                          <span class="badge"><?php echo printPrice($calc->getSubProcessing()); ?>€</span>
                          Fertigungskosten
                      </li>
