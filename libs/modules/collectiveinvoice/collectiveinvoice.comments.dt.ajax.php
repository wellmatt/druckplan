<?php
    ...
    if ( $sWhere == "" )
    {
        $sWhere = " WHERE state = 1 AND module = 'CollectiveInvoice' AND objectid = {$_REQUEST["ciid"]}";
    }
    else
    {
        $sWhere .= " AND state = 1 AND module = 'CollectiveInvoice' AND objectid = {$_REQUEST["ciid"]}";
    }
