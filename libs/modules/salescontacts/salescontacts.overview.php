...
$(document).ready(function() {
    var bcon_table = $('#bcon_table').DataTable( {
        ...
        "processing": true,
        "bServerSide": true,
        "sAjaxSource": "libs/modules/salescontacts/salescontacts.dt.ajax.php",
        "paging": true,
		...
		"tableTools": {
            ...
            "aButtons": [
                         ...
                         "xls",
                         {
                             ...
                             "sPdfMessage": "Contilas - Sales Contacts"
                         },
                         "print"
                     ]
                 },
...
<div class="panel panel-default">
	  <div class="panel-heading">
			<h3 class="panel-title">
				Geschäftskontakte Vertrieb - <?php echo $_USER->getNameAsLine();?>
				<?php /*
