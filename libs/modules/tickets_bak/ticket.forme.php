...
$all_tickets = Ticket::getAllTicketsByUser(Ticket::ORDER_DUE, $_USER->getId());
?>
...
$(document).ready(function() {
    var mytickets = $('#mytickets').DataTable( {
        "scrollY": "350px",
        "paging": true,
		"stateSave": true,
    ...
    $('a.mytickets-toggle-vis').on( 'click', function (e) {
        e.preventDefault();
        var column = mytickets.column( $(this).attr('data-column') );
...
<div>
Toggle: 
	<a data-column="0" class="mytickets-toggle-vis"><?=$_LANG->get('Nr.')?></a> - 
	<a data-column="1" class="mytickets-toggle-vis"><?=$_LANG->get('Titel')?></a> - 
	<a data-column="2" class="mytickets-toggle-vis"><?=$_LANG->get('Erstellt')?></a> - 
	<a data-column="3" class="mytickets-toggle-vis"><?=$_LANG->get('F&auml;llig am')?></a> - 
	<a data-column="4" class="mytickets-toggle-vis"><?=$_LANG->get('Status')?></a> - 
	<a data-column="5" class="mytickets-toggle-vis"><?=$_LANG->get('Kommentar')?></a>
</div>
<table id="mytickets" cellpadding="0" cellspacing="0" width="100%">
	...
	<?	$x = 0;
		foreach($all_tickets as $ticket){
			...
			<tr class="<?=getRowColor($x)?>" onmouseover="mark(this, 0)" onmouseout="mark(this,1)">
				...
				<td class="content_row pointer" align="center" onclick="document.location='index.php?page=libs/modules/tickets/tickets.php&exec=edit&tktid=<?=$ticket->getId()?>'">
