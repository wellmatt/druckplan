...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="index.php?page=libs/modules/paper/paper.import.results.php" name="paperimport" id="paperimport" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    ...
                    Für jedes importierte Papier wird automatisch ein zugehöriger Artikel mit den Lieferanteninformationen und Preisen angelegt.<br>
                    Artikelinformationen und Preise werden bei jedem Import bei vorhanden Papieren aktualisiert.
                </div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading">
