...
//      prettyPrint($sql);
    ...
    public static function ColinvProvCountDay($timestamp, $businesscontact, $user, $article, $tradegroup, $status )
    {
        global $DB;
        date_default_timezone_set('Europe/Berlin');
        $retval = [];
    ...
    public static function ColinvProvCountMonth($timestamp, $businesscontact, $user, $article, $tradegroup, $status )
    {
        global $DB;
        date_default_timezone_set('Europe/Berlin');
        $retval = [];
    ...
    public static function ColinvProvCountYear($timestamp, $businesscontact, $user, $article, $tradegroup, $status)
    {
        global $DB;
        date_default_timezone_set('Europe/Berlin');
        $retval = [];
