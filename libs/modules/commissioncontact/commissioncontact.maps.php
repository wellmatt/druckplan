...
require_once 'libs/modules/businesscontact/commissioncontact.class.php';
...
$_REQUEST["bcid"] = (int)$_REQUEST["bcid"];
$bc = new CommissionContact($_REQUEST["bcid"]);
?>
...
<title>Google Maps <?=$bc->getNameAsLine()?></title>
<style type="text/css">
  html { height: 100% }
