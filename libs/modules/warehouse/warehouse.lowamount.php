...
$all_stocks_lowamount = Warehouse::getAllStocksWithLowAmount();
...
<?	//Lagerabruf heute
	if (count($all_stocks_lowamount) >= 1 && $all_stocks_lowamount != false){?>
		<tr>
	...
	<?	$x=0;
		foreach ($all_stocks_lowamount as $stock){?>
