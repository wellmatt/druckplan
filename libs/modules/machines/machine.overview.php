        ...
        <h3 class="panel-title">
            ...
            <span class="pull-right">
				<button class="btn btn-xs btn-success" type="button"
                        onclick="window.location.href='index.php?page=libs/modules/machines/machine.new.php';">
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        table = $('#datatable').DataTable({
            ...
            ajax: {
                url: 'libs/basic/datatables/machines.php',
                data: {}
            },
            order: [[1, 'desc']],
            columns: [
        ...
        $("#datatable").on('click', 'tbody td', function () {
            ...
            var id = data.id;
            document.location = 'index.php?page=libs/modules/machines/machine.edit.php&id=' + id;
        });
    });
</script>