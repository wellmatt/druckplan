...
$plugins = array('smilies','clearconversation','chattime','avchat','chathistory','filetransfer','handwrite','save','screenshare','whiteboard','writeboard');
...
define('ADMIN_USER','ascherer');
define('ADMIN_PASS','ZGxiPas03');
