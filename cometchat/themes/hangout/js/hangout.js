        ...
        return {
            ...
            initialize: function(){
                ...
                if(settings.showOnlineTab==1){
                    ...
                    usertabpop = '<div id="cometchat_userstab_popup" class="cometchat_tabpopup" style="display:none"><div class="cometchat_userstabtitle"><div class="cometchat_userstabtitletext">'+language[12]+'</div><div class="cometchat_minimizebox cometchat_tooltip" id="cometchat_minimize_userstab_popup" data-title="Minimize User Tab"></div><br clear="all"/></div>'+trayData+'<div class="cometchat_tabsubtitle" id="cometchat_searchbar"><input type="text" name="cometchat_search" class="cometchat_search cometchat_search_light" id="cometchat_search" value="'+language[18]+'"></div><div class="cometchat_tabcontent cometchat_tabstyle"><div id="cometchat_userscontent"><div id="cometchat_userslist"><div class="cometchat_nofriends">'+language[41]+'</div></div></div></div></div>';
                }
            ...
            createChatboxData: function(id, name, status, message, avatar, link, silent, tryOldMessages){
                ...
                shortname = name;
                longname = name;
                $("<span/>").attr("id", "cometchat_user_"+id).attr("amount", 0).addClass("cometchat_tab").html('<div class="cometchat_icon"></div><div class="cometchat_user_shortname">'+shortname+'</div><div class="cometchat_closebox_bottom cometchat_tooltip" id="cometchat_closebox_bottom_'+id+'" data-title="Close Tab"></div>').appendTo($("#cometchat_chatboxes_wide"));
                var pluginshtml = '';
				var smiliehtml = '';
                ...
                cometchat_tabtitle.append('<div class="cometchat_closebox cometchat_tooltip" id="cometchat_closebox_'+id+'" data-title="Close Tab"></div><div class="cometchat_minimizebox cometchat_tooltip" id="cometchat_minimizebox_'+id+'" data-title="Minimize Tab"></div><br clear="all"/>');
                                    ...
                                    if(cometchat_tabcontenttext_incomingfrom.find(".cometchat_chatboxmessage:last").hasClass('self')){
                                        if($("#cometchat_message_"+incoming.id)>0){
                                            ...
                                            if(cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last.self div.cometchat_chatboxmessagecontent').hasClass('cometchat_self_content')){
                                                cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last.self .cometchat_self_content span.cometchat_ts').before('<div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+'">'+incoming.message+'</div>');
                                            }
                                        }
                                    ...
                                    if(cometchat_tabcontenttext_incomingfrom.find('div.cometchat_chatboxmessage:last').hasClass('other')){
                                        if($("#cometchat_message_"+incoming.id)>0){
                                            ...
                                            if(cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last.other div.cometchat_chatboxmessagecontent  ').hasClass('cometchat_other_content')){
                                                cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last .cometchat_other_content .cometchat_message_name').before('<div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+' cometchat_other_noarrow">'+incoming.message+'</div>');
                                            }
                                        }
            ...
            getTimeDisplay: function(ts){
                ...
                return ts<jqcc.cometchat.getThemeVariable('todays12am') ? months[month]+' '+date+', '+hour+":"+minute+' '+ap : hour+":"+minute+ap;
            },
                    ...
                    if(type=='messages'){
                        $.each(item, function(i, incoming){
                            ...
                            if(incoming.self==1){
                                ...
                                if(cometchat_tabcontenttext_incomingfrom.find('div.cometchat_chatboxmessage:last').hasClass('self')){
                                    cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last .cometchat_self_content span.cometchat_ts').before('<div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+'">'+incoming.message+'</div>');
                                    cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last .cometchat_self_content span.cometchat_ts').html(jqcc[settings.theme].getTimeDisplay(ts));
                                    jqcc[settings.theme].scrollDown(id);
                                }else{
                                ...
                                if(cometchat_tabcontenttext_incomingfrom.find('div.cometchat_chatboxmessage:last').hasClass('other')){
                                    if(!$("#cometchat_message_"+incoming.id).length){
                                        cometchat_tabcontenttext_incomingfrom.find('.cometchat_chatboxmessage:last .cometchat_other_content .cometchat_message_name').before('<div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+' cometchat_other_noarrow">'+incoming.message+'</div>');
                                        $('#cometchat_tabcontenttext_'+incoming.from+' .cometchat_chatboxmessage:last .cometchat_other_content span.cometchat_ts').html(jqcc[settings.theme].getTimeDisplay(ts));
                                        jqcc[settings.theme].scrollDown(id);
                                    }
                                }else{
                                    $("#cometchat_tabcontenttext_"+id).append((jqcc[settings.theme].processMessage('<div class="cometchat_chatboxmessage other" ><div class="cometchat_chatboxmessagefrom '+selfstyleAvatar+'"><a href="'+jqcc.cometchat.getThemeArray('buddylistLink', incoming.from)+'"><img src="'+jqcc.cometchat.getThemeArray('buddylistAvatar', incoming.from)+'" title="'+fromname+'"/></a></div><div class="cometchat_chatboxmessagecontent '+selfstyleCont+'"><div id="cometchat_message_'+incoming.id+'" class="'+selfstyle+'">'+incoming.message+'</div><span class="cometchat_message_name">'+fromname+' <strong>.</strong></span><span class="cometchat_ts">'+jqcc[settings.theme].getTimeDisplay(ts)+'</span></div></div>', selfstyle)));
                                    jqcc[settings.theme].scrollDown(id);
                                }
                            }
                        });
            ...
            windowResize: function(silent){
				...
				jqcc('.cometchat_tabpopup').each(function(i){
					var popupId = jqcc(this).attr('id').split('_')[2];
					if(!isNaN(popupId)) {
						var popupLeft= jqcc('#cometchat_user_'+popupId).offset().left;
						jqcc('#cometchat_user_'+popupId+'_popup').css('left',popupLeft+'px');
					}
				});
                $.each(chatboxOpened, function(openChatboxId, state){
                    if(state==1&&silent!=1&&$("#cometchat_user_"+openChatboxId).length>0){
                        ...
                        if((cometchat_user_openChatboxId.offset().left<(cometchat_chatboxes.offset().left+cometchat_chatboxes.width()))&&(cometchat_user_openChatboxId.offset().left-cometchat_chatboxes.offset().left)>=0){
                            cometchat_user_openChatboxId.css('left', baseLeft+cometchat_user_openChatboxId.offset().left-((chatboxWidth)-230+20));
                        }else{

                            cometchat_user_openChatboxId.removeClass('cometchat_tabclick').removeClass("cometchat_usertabclick");
                            var newPosition = ((cometchat_user_openChatboxId.offset().left-$("#cometchat_chatboxes_wide").offset().left))-((Math.floor((cometchat_chatboxes.width()/230))-1)*230);
                            cometchat_chatboxes.scrollToCC(newPosition+'px', 0, function(){
                                cometchat_user_openChatboxId.click();
                            });
                        }
                    }
                });
