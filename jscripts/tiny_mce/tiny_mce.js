			...
			.create(
					"tinymce.dom.DOMUtils",
					{
						...
						nodeIndex : function(n, o) {
							var j = 0, l, m, k;
							if (n) {
								for (l = n.nodeType, n = n.previousSibling,
										m = n; n; n = n.previousSibling) {
									k = n.nodeType;
									if (o && k == 3) {
					...
					"tinymce.dom.Selection",
					{
						...
						setContent : function(g, i) {
							...
							if (f.insertNode) {
								...
								if (/^\s+/.test(g)) {
									f.pasteHTML('<span id="__mce_tmp">_</span>'
											+ g);
					...
					"tinymce.Editor",
					{
						...
						init : function() {
							...
							for (A = 0; A < I.contentCSS.length; A++) {
								I.iframeHTML += '<link type="text/css" rel="stylesheet" href="'
										+ I.contentCSS[A] + '" />'
							}
							I.contentCSS = [];
							z = J.body_id || "tinymce";
