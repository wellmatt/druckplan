...
//----------------------------------------------------------------------------------
$pdf->ezText("<b>Angebotsbest&auml;tigung Nr. {$this->name}         Kunden-Nr. {$order->getCustomer()->getId()}</b>", 14);
$pdf->ezText("Auftrag: {$order->getTitle()}", 12);
$pdf->ezText("", 14);
$pdf->ezText("Sehr geehrte Damen und Herren,", 10);

$pdf->ezText("", 10);
$pdf->ezText("vielen Dank f&uuml;r Ihren Auftrag.",10);
$pdf->ezText("", 10);
$pdf->ezText("Wir best&auml;tigen Ihnen wie folgt:",10);
$pdf->ezText("", 10);
